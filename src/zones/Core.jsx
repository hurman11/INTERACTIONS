...
export default function Core({ visible = true }) {
  ...
  return (
    <group position={[0, 0, -15]}>
      ...
      <pointLight position={[0, 6, 2]} color="#00E5FF" intensity={0.6} distance={15} decay={2} />
      <pointLight position={[-4, -1, 3]} color="#D946EF" intensity={0.4} distance={12} decay={2} />
      <pointLight position={[4, 2, -2]} color="#1e3a5f" intensity={0.3} distance={10} decay={2} />
    </group>
  )
}
